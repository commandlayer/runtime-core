...
export declare const COMMAND_LAYER_CURRENT_LINE: "1.1.0";
export declare const DEFAULT_SCHEMA_VERSION: "v1";
export declare const COMMONS_CONTRACT: "commons";
export declare const COMMERCIAL_CONTRACT: "commercial";
export declare const DEFAULT_CANONICAL_ID: "json.sorted_keys.v1";
